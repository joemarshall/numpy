...
#define _define_get(UPPER, lower) \
    static PyObject * \
    arrayflags_ ## lower ## _get(PyArrayFlagsObject *self,void *NPY_UNUSED(ignored)) \
    { \
...
static int
arrayflags_updateifcopy_set(PyArrayFlagsObject *self, PyObject *obj,void *NPY_UNUSED(ignored))
{
    PyObject *res;
...
/* relies on setflags order being write, align, uic */
static int
arrayflags_writebackifcopy_set(PyArrayFlagsObject *self, PyObject *obj,void *NPY_UNUSED(ignored))
{
    PyObject *res;
...
static int
arrayflags_aligned_set(PyArrayFlagsObject *self, PyObject *obj,void *NPY_UNUSED(ignored))
{
    PyObject *res;
...
static int
arrayflags_writeable_set(PyArrayFlagsObject *self, PyObject *obj,void *NPY_UNUSED(ignored))
{
    PyObject *res;
...
static int
arrayflags_warn_on_write_set(PyArrayFlagsObject *self, PyObject *obj,void *NPY_UNUSED(ignored))
{
    /*
